import {
  ...
  export interface OnApprove {
    onApprove(arg0: OnApproveData, arg1: OnApproveActions): Promise<void>;
  }
  
  export interface OnShippingChange {
    onShippingChange(
      arg0: OnShippingChangeData,
      arg1: OnShippingChangeActions
    ): Promise<void>;
  }
  ...
  export class PayPalButtons implements OnChanges, OnDestroy {
    ...
    @Input() layout: ButtonsLayout = 'vertical';
